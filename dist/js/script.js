            ...
            schedules[stageId].forEach(schedule => {
                const row = `
                    <tr class="border-b bg-gray-800 border-gray-700">
                        ...
                        <td class="px-6 py-4">${schedule.referee}</td>
                        <td class="px-6 py-4">${schedule.player}</td>
                        <td class="px-6 py-4"><a class="underline" href="${schedule.mpLink}" target="_blank">click</a></td>
                    </tr>
                `;
